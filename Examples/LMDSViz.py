...
def Visualise(DataReduced_coords, colouring, population_size, label2 = 'problem' ):
		'''
...
def XYCreate(TotalPopulation, population_size):
	'''Creates Xs as total population in varaible space 
	and Ys as total popualtion in objective space'''
